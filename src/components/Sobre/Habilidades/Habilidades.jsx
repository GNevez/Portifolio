...
const Habilidades = () => {
  return (
    <>
      <h3 className={style.mainText}>Minhas habilidades</h3>
      <p className={style.subText}>
        Todas minhas principais habilidades e competências na tecnologia!
      </p>
      <div className="container">
        <div className="row">
          <div
            className={
              style.containerCards + " col-lg-12 d-flex gap-4 p-0 mb-4"
            }
          >
            <div className={style.cardSkill}>
              <svg
                className={style.iconSkill}
          ...
          >
            <div className={style.cardSkill}>
              <svg
                ...
                data-tooltip-content="Angular Js"
              >
                <path
                  fill="#ffffff"
          ...
          <div className={style.containerCards + " col-lg-12 d-flex gap-4 p-0"}>
            <div className={style.cardSkill}>
              <svg
                className={style.iconSkill}
                xmlns="http://www.w3.org/2000/svg"
